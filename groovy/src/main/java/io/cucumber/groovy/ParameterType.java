...
public @interface ParameterType {
     ...
     * matching text against a {@link RegularExpression}. In case there are
     * multiple parameter types with a regexp identical to the capture group's
     * regexp, a preferential parameter type will win. If there are more than 1
